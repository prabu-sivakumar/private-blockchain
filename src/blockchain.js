...
class Blockchain {
    ...
    _addBlock(block) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            //Get the previous block hash if there is a previous block
            ...
            //Increment the height of the chain
            self.height += 1;
    ...
    submitStar(address, message, signature, star) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            if (blockTime > currentTime - 300000) {
                if (bitcoinMessage.verify(message, address, signature)) {
                    let block = new BlockClass.Block({ "owner": address, "star": star });
                    await self._addBlock(block);
                    resolve(block);
                } else {
                    reject(Error("Block message could not be verified"));
                }
            } else {
                reject(Error("Block could not be added as time elapsed is less than 5 minutes"))
            }
        });
    }
    ...
    validateChain() {
        ...
        return new Promise(async (resolve, reject) => {
            if (self.height > 0) {
                ...
                errorLog.push("Chain is empty, has no blocks to validate");
            }
            resolve(errorLog);
        });
    }
